    ...
    <div className="min-h-screen flex flex-col bg-[#15130F] text-[#EDE7DA] selection:bg-[#C97A2E]/30" style={sans}>
      ...
      <main className="flex-1 flex items-center justify-center p-6 relative">
        ...
        <div className="relative w-full max-w-md my-8">
          {/* Case-file card — same paper surface as sign-in and the console */}
          <div className="relative rotate-1">
            <div className="absolute -top-3 right-10 w-10 h-3 bg-[#8B8272]/50 -rotate-6 rounded-xs" />
            <div className="p-8 sm:p-9 rounded-sm bg-[#EDE6D3] text-[#201B12] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.6)]">
              <div className="text-center mb-7 pb-6 border-b border-[#C9BFA4]">
                ...
                <h1 className="text-2xl font-bold text-[#201B12]" style={slab}>Create analyst account</h1>
                    ...
                    {confirmPassword && (
                      <span
                        className={`text-[10px] font-semibold flex items-center gap-1 ${
                          passwordsMatch ? 'text-[#4F7350]' : 'text-[#B5493A]'
                        }`}
                        style={mono}
                      >
                        {passwordsMatch ? (
              ...
              <div className="mt-7 text-center pt-5 border-t border-[#C9BFA4]">
                <p className="text-xs text-[#6B6250]">
                  Already registered?{' '}
                  <Link to="/login" className="font-semibold text-[#8A4E17] hover:text-[#C97A2E] transition-colors">
                    Sign in
                  </Link>
                </p>
              </div>
